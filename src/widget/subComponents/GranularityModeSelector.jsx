...
export default class GranularityModeSelector extends React.Component {
  constructor(props) {
    ...
    this.generateGranularityModeSwitchButton = this.generateGranularityModeSwitchButton.bind(
      this,
    );
    ...
    this.getSelectedGranularityLevel = this.getSelectedGranularityLevel.bind(
      this,
    );
  }
 ...
 getDateTimeRangeInfo, options, onChangeCustom, theme 
  ...
  getSelectedGranularityLevel() {
    ...
    if (this.getHighGranularityOptions().indexOf(selectedTimeRange) > -1) {
      ...
      this.getLowGranularityOptions().indexOf(selectedTimeRange) > -1
    ) {
      return "low";
    } else {
